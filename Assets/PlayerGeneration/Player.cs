 ...
 * TODO: Move to player
*/
    public void InitializePlayerFromSerializedObj(SerializedPlayer serializedPlayer)
    {
        ...
        this.respawnLoc = new Vector2(serializedPlayer.respawnX, serializedPlayer.respawnY);
